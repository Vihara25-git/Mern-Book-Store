        ...
        <div className='px-4 lg:px-24 bg-purple-200 flex items-center'>
            <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
                ...
                <div className='md:w-1/2 space-y-8 h-full'>
                    <h2 className='text-5xl font-bold leading-snug text-black'>Buy and sell Your Books <span className='text-purple-900'>for
                    ...
                    <div className="flex">
                        <input
                            ...
                            className='py-2 px-2 rounded-l-sm outline-none flex-grow'
                            value={searchTerm}
                        ...
                        <button
                            ...
                            className='bg-purple-900 px-6 py-2 text-white font-medium hover:bg-black transition-all ease-in duration-200 rounded-r-sm'
                        >
                            Search
                        </button>
                    </div>
